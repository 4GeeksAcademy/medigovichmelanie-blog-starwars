        ...
        <div className="col-md-3 col-lg-2 col-sm-6 col-12">
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">Model: {detalle.model}</p>
                    <p className="card-text">Passengers: {detalle.passengers}</p>
                    <p className="card-text">Vehicle Class: {detalle.vehicle_class}</p>
